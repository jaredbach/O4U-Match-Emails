...
class EmailSenderApp:
    ...
    def upload_csv(self):
        ...
        try:
            ...
            required_columns = ['MentorEmail', 'MenteeEmail', 'MentorFirstName', 'MentorLastName', 'MenteeFirstName', 'MenteeLastName', 'JobTitle', 'PlaceOfWork', 'Major', 'University']
    ...
    def show_email_preview(self, text_widget, index):
        if self.df is not None and 0 <= index < len(self.df):
            ...
            email_body = self.body_template.format(
                ...
                MenteeFirstName=row['MenteeFirstName'],
